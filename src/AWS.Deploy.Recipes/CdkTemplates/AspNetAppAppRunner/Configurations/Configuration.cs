...
namespace AspNetAppAppRunner.Configurations
{
    public class Configuration
    {
        ...
        /// <summary>
        /// The Identity and Access Management (IAM) role that provides gives the AWS App Runner service access to pull the container image from ECR.
        /// </summary>
...
#nullable restore warnings
        ...
        public Configuration(
            ...
            int? port,
            string? startCommand,
            string? encryptionKmsKey,
            double? healthCheckHealthyThreshold,
